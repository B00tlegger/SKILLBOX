...
public class Main {
    ...
    private static Logger search;
    private static Logger inputErrors;
    private static Logger exceptions;

    private static StationIndex stationIndex;

    public static void main(String[] args) {
        RouteCalculator calculator = getRouteCalculator();
        search = LogManager.getLogger("search");
        inputErrors = LogManager.getLogger("inputErrors");
        exceptions = LogManager.getLogger("exceptions");
